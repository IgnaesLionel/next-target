...
MClose = ${data.MClose} + gap
        ...
        DRAWTEXT("Pivot M ${market}",barindex+2,MPP+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WR1 ${market}",barindex+2,MR1+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WR2 ${market}",barindex+2,MR2+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WR3 ${market}",barindex+2,MR3+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WS1 ${market}",barindex+2,MS1+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WS2 ${market}",barindex+2,MS2+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
        DRAWTEXT("WS3 ${market}",barindex+2,MS3+Voffset,SansSerif,Bold,10)coloured(36, 185, 255)
