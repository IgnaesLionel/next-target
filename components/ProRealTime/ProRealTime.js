...
MClose = ${data.MClose} + gap
        ...
        DRAWHLINE(DPP ${market})coloured(0,227,0)
        DRAWHLINE(DR1 ${market})coloured(0,227,0)
        DRAWHLINE(DR2 ${market})coloured(0,227,0)
        DRAWHLINE(DR3 ${market})coloured(0,227,0)
        DRAWHLINE(DS1 ${market})coloured(0,227,0)
        DRAWHLINE(DS2 ${market})coloured(0,227,0)
        DRAWHLINE(DS3 ${market})coloured(0,227,0)
        DRAWHLINE(WPP ${market})coloured(0,0,255)
        DRAWHLINE(WR1 ${market})coloured(0,0,255)
        DRAWHLINE(WR2 ${market})coloured(0,0,255)
        DRAWHLINE(WR3 ${market})coloured(0,0,255)
        DRAWHLINE(WS1 ${market})coloured(0,0,255)
        DRAWHLINE(WS2 ${market})coloured(0,0,255)
        DRAWHLINE(WS3 ${market})coloured(0,0,255)
        DRAWHLINE(MPP ${market})coloured(255, 192, 203)
        DRAWHLINE(MR1 ${market})coloured(255, 192, 203)
        DRAWHLINE(MR2 ${market})coloured(255, 192, 203)
        DRAWHLINE(MR3 ${market})coloured(255, 192, 203)
        DRAWHLINE(MS1 ${market})coloured(255, 192, 203)
        DRAWHLINE(MS2 ${market})coloured(255, 192, 203)
        DRAWHLINE(MS3 ${market})coloured(255, 192, 203)
