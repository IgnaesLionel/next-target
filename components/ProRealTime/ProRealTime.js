...
MClose = ${data.MClose} + gap
        ...
        DRAWTEXT("DR2 ${market}",barindex+50,DR2+Voffset,SansSerif,Bold,10)coloured(0,255,0)
        DRAWTEXT("DR3 ${market}",barindex+50,DR3+Voffset,SansSerif,Bold,10)coloured(0,255,0)
        DRAWTEXT("DS1 ${market}",barindex+50,DS1+Voffset,SansSerif,Bold,10)coloured(0,255,0)
        DRAWTEXT("DS2 ${market}",barindex+50,DS2+Voffset,SansSerif,Bold,10)coloured(0,255,0)
        DRAWTEXT("DS3 ${market}",barindex+50,DS3+Voffset,SansSerif,Bold,10)coloured(0,255,0)
        DRAWTEXT("Pivot W ${market}",barindex+50,WPP+Voffset,SansSerif,Bold,10)coloured(0,0,255)
