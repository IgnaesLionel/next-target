...
useEffect(() => {
  ...
  g0 = ${roundedNumber[0]} + gap
   ...
   DRAWTEXT("${roundedNumber[27]} ${market}",barindex+10,g27+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[28]} ${market}",barindex+10,g28+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[29]} ${market}",barindex+10,g29+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[30]} ${market}",barindex+10,g30+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[31]} ${market}",barindex+10,g31+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[32]} ${market}",barindex+10,g32+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[33]} ${market}",barindex+10,g33+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[34]} ${market}",barindex+10,g34+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[35]} ${market}",barindex+10,g35+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[36]} ${market}",barindex+10,g36+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[37]} ${market}",barindex+10,g37+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[38]} ${market}",barindex+10,g38+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[39]} ${market}",barindex+10,g39+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[40]} ${market}",barindex+10,g40+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[41]} ${market}",barindex+10,g41+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[42]} ${market}",barindex+10,g42+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[43]} ${market}",barindex+10,g43+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[44]} ${market}",barindex+10,g44+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[45]} ${market}",barindex+10,g45+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[46]} ${market}",barindex+10,g46+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[47]} ${market}",barindex+10,g47+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[48]} ${market}",barindex+10,g48+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[49]} ${market}",barindex+10,g49+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[50]} ${market}",barindex+10,g50+Voffset,SansSerif,Bold,10)coloured(255,255,255)
