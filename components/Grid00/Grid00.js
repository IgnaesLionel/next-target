...
const Grid00 = ({ data, spread, market }) => {
  ...
  return (
    ...
    g0 = ${roundedNumber[0]} + gap
     ...
     DRAWTEXT("${roundedNumber[8]} ${market}",barindex+2,g8+Voffset,SansSerif,Bold,10)coloured(255,255,255) DRAWTEXT("${roundedNumber[0]} ${market}",barindex+2,g0+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[9]} ${market}",barindex+2,g1+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[10]} ${market}",barindex+2,g2+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[11]} ${market}",barindex+2,g3+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[12]} ${market}",barindex+2,g4+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[13]} ${market}",barindex+2,g5+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[14]} ${market}",barindex+2,g6+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[15]} ${market}",barindex+2,g7+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[16]} ${market}",barindex+2,g8+Voffset,SansSerif,Bold,10)coloured(255,255,255) DRAWTEXT("${roundedNumber[0]} ${market}",barindex+2,g0+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[17]} ${market}",barindex+2,g1+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[18]} ${market}",barindex+2,g2+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[19]} ${market}",barindex+2,g3+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[20]} ${market}",barindex+2,g4+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[21]} ${market}",barindex+2,g5+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[22]} ${market}",barindex+2,g6+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[23]} ${market}",barindex+2,g7+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[24]} ${market}",barindex+2,g8+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[25]} ${market}",barindex+2,g7+Voffset,SansSerif,Bold,10)coloured(255,255,255)
     DRAWTEXT("${roundedNumber[26]} ${market}",barindex+2,g8+Voffset,SansSerif,Bold,10)coloured(255,255,255)
    RETURN 
    `}
      />
    </div>
