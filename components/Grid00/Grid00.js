...
useEffect(() => {
  ...
  g0 = ${roundedNumber[0]} + gap
   ...
   DRAWHLINE(g9)coloured(255,0,0)
   DRAWHLINE(g10)coloured(255,0,0)
   DRAWHLINE(g11)coloured(255,0,0)
   DRAWHLINE(g12)coloured(255,0,0)
   DRAWHLINE(g13)coloured(255,0,0)
   DRAWHLINE(g14)coloured(255,0,0)
   DRAWHLINE(g15)coloured(255,0,0)
   DRAWHLINE(g16)coloured(255,0,0)
   DRAWHLINE(g17)coloured(255,0,0)
   DRAWHLINE(g18)coloured(255,0,0)
   DRAWHLINE(g19)coloured(255,0,0)
   DRAWHLINE(g20)coloured(255,0,0)
   DRAWHLINE(g21)coloured(255,0,0)
   DRAWHLINE(g22)coloured(255,0,0)
   DRAWHLINE(g23)coloured(255,0,0)
   DRAWHLINE(g24)coloured(255,0,0)
   DRAWHLINE(g25)coloured(255,0,0)
   DRAWHLINE(g26)coloured(255,0,0)
   ...
   DRAWHLINE(g33)coloured(255,0,0)
   DRAWHLINE(g34)coloured(255,0,0)
   DRAWHLINE(g35)coloured(255,0,0)
   DRAWHLINE(g36)coloured(255,0,0)
   DRAWHLINE(g37)coloured(255,0,0)
   DRAWHLINE(g38)coloured(255,0,0)
   DRAWHLINE(g39)coloured(255,0,0)
   DRAWHLINE(g40)coloured(255,0,0)
   DRAWHLINE(g41)coloured(255,0,0)
   DRAWHLINE(g42)coloured(255,0,0)
   DRAWHLINE(g43)coloured(255,0,0)
   DRAWHLINE(g44)coloured(255,0,0)
   DRAWHLINE(g45)coloured(255,0,0)
   DRAWHLINE(g46)coloured(255,0,0)
   DRAWHLINE(g47)coloured(255,0,0)
   DRAWHLINE(g48)coloured(255,0,0)
   DRAWHLINE(g49)coloured(255,0,0)
   DRAWHLINE(g50)coloured(255,0,0)
