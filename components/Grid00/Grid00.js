...
useEffect(() => {
  ...
  g0 = ${roundedNumber[0]} + gap
   ...
   DRAWTEXT("${roundedNumber[27]} ${market}",barindex+10,g10+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[28]} ${market}",barindex+10,g11+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[29]} ${market}",barindex+10,g12+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[30]} ${market}",barindex+10,g13+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[31]} ${market}",barindex+10,g14+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[32]} ${market}",barindex+10,g15+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[33]} ${market}",barindex+10,g16+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[34]} ${market}",barindex+10,g17+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[35]} ${market}",barindex+10,g18+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[36]} ${market}",barindex+10,g19+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[37]} ${market}",barindex+10,g20+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[38]} ${market}",barindex+10,g21+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[39]} ${market}",barindex+10,g22+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[40]} ${market}",barindex+10,g23+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[41]} ${market}",barindex+10,g24+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[42]} ${market}",barindex+10,g25+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[43]} ${market}",barindex+10,g26+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[44]} ${market}",barindex+10,g18+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[45]} ${market}",barindex+10,g19+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[46]} ${market}",barindex+10,g20+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[47]} ${market}",barindex+10,g21+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[48]} ${market}",barindex+10,g22+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[49]} ${market}",barindex+10,g23+Voffset,SansSerif,Bold,10)coloured(255,255,255)
   DRAWTEXT("${roundedNumber[50]} ${market}",barindex+10,g24+Voffset,SansSerif,Bold,10)coloured(255,255,255)
